...
use common_code::architecture::Architecture;
use common_code::bootconfig::group;
use common_code::configuration::Configuration;
use common_code::imagefile::Imagefile;
use common_code::mountpoint::{get_mount_order, Mountpoint};
use common_code::provisioner::Types::{FILE, SHELL};
use common_code::utils::{get_random_name, print_message, sha256sum_of_file};
...
fn create_baseimage_sandbox() -> String {
    let sandbox_name = common_code::utils::get_random_name();
    print_message(
